...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='D:/AAAproject/yolov5-master/yolov5s-seg.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='D:/AAAproject/yolov5-master-DRR/models/segment/yolov5s-seg-C3RFEM-DSConV.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='D:/AAAproject/yolov5-master-DRR/data/mydatasets.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--evolve', type=int, nargs='?', const=300, help='evolve hyperparameters for x generations')#default=,
